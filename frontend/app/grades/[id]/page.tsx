...
export default function GradeDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <MobileShell title={subject.name} subtitle="Notenübersicht" showBack>
      <div className="p-margin flex flex-col gap-lg">
        ...
        <Card variant="glass" className="flex items-center justify-between">
          <div className="flex flex-col">
            ...
            <Typography variant="display" className="text-accent">{subject.averageGrade.toFixed(2)}</Typography>
          </div>
        ...
        <Card variant="elevated" className="bg-surface-container-low border-none">
          ...
          <Typography variant="body-md">
            Die Gewichtung der Noten entspricht den offiziellen Richtlinien des Moduls {subject.id.toUpperCase()}.
          </Typography>
        </Card>
      </div>
    </MobileShell>
